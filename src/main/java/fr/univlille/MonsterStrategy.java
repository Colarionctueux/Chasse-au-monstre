...
public class MonsterStrategy implements IMonsterStrategy {
    ...
    int fog; // distance of fog around the monster, he's only supposed to know what is
             // "brouillard" number of blocks around.
    ...
    public ICoordinate play() {
        ...
        /*
         * Very simple implementation, goes to the direction of the exit if there are no
         * walls where we want to go
         * If exit is above and right of the monster, the monster will go on the block
         * above, to get closer to the exit, assuming no wall is there
         */
